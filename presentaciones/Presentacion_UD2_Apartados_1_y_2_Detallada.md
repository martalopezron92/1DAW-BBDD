# Presentación Detallada: Modelo Entidad/Relación
## Apartados 1 y 2 - Introducción y Elementos Básicos
...
### 1.5. Notación Básica del Modelo E/R

**Pregunta:** ¿Cómo representamos gráficamente los elementos del modelo?
...
### 1.6. Ejemplo Completo: Sistema de Biblioteca
...
**Pregunta de transición:** Tenemos entidades con sus atributos, ¿pero cómo se conectan entre sí?
...
**En las siguientes sesiones estudiaremos:**

1. **Entidades Débiles** en profundidad
2. **Relaciones N-arias** complejas
3. **Control de Redundancia**
4. **Modelo E/R Extendido** (jerarquías, herencia)
5. **Transformación** a modelo relacional
...
**Enunciado:** Para el sistema "Una clínica veterinaria atiende mascotas de dueños registrados. Cada mascota tiene un historial de visitas con diagnósticos y tratamientos. Los veterinarios realizan las consultas."
...
3. Relaciones
4. Cardinalidades
5. Atributos de relaciones (si los hay)

---

### Ejercicio 2: Clasificar Atributos

Para la entidad **PRODUCTO** con estos atributos:
- Cod_Producto, Nombre, Descripción
- Precio_Base, IVA, Precio_Total
- Stock, Stock_Mínimo
- Fecha_Alta, Días_En_Catálogo
- Categoría, Subcategoría
- Proveedor_1, Proveedor_2, Proveedor_3

**Clasifica cada atributo:**
- ¿Clave o descriptor?
- ¿Simple o compuesto?
...
### Ejercicio 3: Determinar Cardinalidades

Para estos casos, determina la cardinalidad y participación:

1. AUTOR escribe LIBRO
2. PERSONA tiene DNI
3. PACIENTE ingresa en HABITACIÓN
4. ALUMNO cursa ASIGNATURA
5. PAÍS tiene CAPITAL

---

**¡Fin de la presentación de los apartados 1 y 2!**
